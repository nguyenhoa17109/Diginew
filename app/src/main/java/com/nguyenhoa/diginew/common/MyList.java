...
//    }
    ...
    private void runOnce() {
        ...
        keywordArrayList.add(new Keyword("Covid-19", 19, "06/08/2021"));
        keywordArrayList.add(new Keyword("Viet Nam covid", 10, "06/08/2021"));
        keywordArrayList.add(new Keyword("Virut", 10, "06/08/2021"));
        keywordArrayList.add(new Keyword("Prime", 10, "07/08/2021"));
        keywordArrayList.add(new Keyword("Breakdown", 10, "06/08/2021"));
        keywordArrayList.add(new Keyword("Anthony Fauci", 10, "01/08/2021"));
        keywordArrayList.add(new Keyword("Wisconsin", 10, "16/08/2021"));
        keywordArrayList.add(new Keyword("Coronavirus", 10, "06/08/2021"));
        keywordArrayList.add(new Keyword("Nepal", 10, "06/08/2021"));
        keywordArrayList.add(new Keyword("Animal", 10, "06/08/2021"));
        keywordArrayList.add(new Keyword("Washington", 10, "06/08/2021"));
        keywordArrayList.add(new Keyword("Entertainment", 10, "06/08/2021"));
        for(int i=0; i<keywordArrayList.size(); i++){
            Keyword keyword = keywordArrayList.get(i);
            if(!sqLite.CheckIsDataAlreadyInDBorNot("keywords", "keys", keyword.getKey())) {
                sqLite.addKeyword(keyword);
            }
        }

        ArrayList<Topic> topicArrayList = new ArrayList<>();
        topicArrayList.add(new Topic("Đời sống", "https://cdn.pixabay.com/photo/2017/03/26/21/54/yoga-2176668_1280.jpg"));
        topicArrayList.add(new Topic("Kinh tế", "https://cdn.pixabay.com/photo/2016/09/19/18/30/calculator-1680905_1280.jpg"));
        topicArrayList.add(new Topic("Sức khỏe", "https://cdn.pixabay.com/photo/2016/08/10/20/26/blood-pressure-1584223_1280.jpg"));
        topicArrayList.add(new Topic("Xã hội", "https://cdn.pixabay.com/photo/2014/12/17/21/55/smartphone-571961_1280.jpg"));
        topicArrayList.add(new Topic("Khoa học", "https://cdn.pixabay.com/photo/2017/02/01/13/52/analysis-2030261_1280.jpg"));
        topicArrayList.add(new Topic("Giải trí", "https://cdn.pixabay.com/photo/2015/11/22/19/04/crowd-1056764_1280.jpg"));
        topicArrayList.add(new Topic("Công nghệ", "https://cdn.pixabay.com/photo/2015/06/24/15/45/hands-820272_1280.jpg"));
        topicArrayList.add(new Topic("Thể thao", "https://cdn.pixabay.com/photo/2016/09/18/14/21/swimmer-1678307_1280.jpg"));
        topicArrayList.add(new Topic("Tâm sự", "https://cdn.pixabay.com/photo/2013/10/13/18/53/heart-195147_1280.jpg"));
        for(int i=0; i<topicArrayList.size(); i++){
            Topic topic = topicArrayList.get(i);
            if(!sqLite.CheckIsDataAlreadyInDBorNot("topics", "name", topic.getName())) {
                sqLite.addTopic(topic);
            }
        }
        listTopic = sqLite.getAllTopic();

        ArrayList<OtherApp> otherAppArrayList = new ArrayList<>();
        otherAppArrayList.add(new OtherApp("DigiMovie", R.drawable.ic_digimovie, R.raw.digimovie
                , "https://play.google.com/store/apps/details?id=com.vnpt.media.digimovie&hl=en&gl=US"));
        otherAppArrayList.add(new OtherApp("DigiClip", R.drawable.ic_digiclips, R.raw.digiclip
                , "https://play.google.com/store/apps/details?id=com.vnpt.media.digiclip&hl=en&gl=US"));
        otherAppArrayList.add(new OtherApp("DigiMusic", R.drawable.ic_digimusic, R.raw.digimusic
                , "https://play.google.com/store/apps/details?id=com.vnpt.media&hl=en&gl=US"));
        otherAppArrayList.add(new OtherApp("DigiHealth", R.drawable.ic_digihealth, R.raw.digihealth
                , "https://play.google.com/store/apps/details?id=com.vnpt.media.digihealth&hl=en&gl=US"));
        otherAppArrayList.add(new OtherApp("MyTV", R.drawable.img_mytv, R.raw.mytv
                , "https://play.google.com/store/apps/details?id=vn.vnpt.media.mytvgame&hl=en&gl=US"));
        for(int i=0; i<otherAppArrayList.size(); i++) {
            OtherApp otherApp = otherAppArrayList.get(i);
            if (!sqLite.CheckIsDataAlreadyInDBorNot("others", "name", otherApp.getName())) {
                sqLite.addOtherApp(otherApp);
            }
        }
        list_dis = sqLite.getAllOtherApp();

        ArrayList<Tag> tagArrayList = new ArrayList<>();
        tagArrayList.add(new Tag("Covid-19"));
        tagArrayList.add(new Tag("virus"));
        tagArrayList.add(new Tag("Animal"));
        for(int i=0; i<tagArrayList.size(); i++){
            Tag tag = tagArrayList.get(i);
            if(!sqLite.CheckDataTagExist(tag)){
                sqLite.addTag(tag);
            }
        }
        listTag = sqLite.getAllTag();
        ...
        provinceArrayList.add(new Province( "Ha Noi"));
        provinceArrayList.add(new Province( "Hai Phong"));
        provinceArrayList.add(new Province( "Ha Giang"));
        provinceArrayList.add(new Province( "Hai Duong"));
        provinceArrayList.add(new Province( "Bac Ninh"));
        for(int i=0; i<provinceArrayList.size(); i++){
            Province province = provinceArrayList.get(i);
            if(!sqLite.CheckIsDataAlreadyInDBorNot("provinces", "name", province.getName())){
                sqLite.addProvince(province);
            }
        }
        listProvince = sqLite.getAllProvince();
        Log.d("ALO", listProvince.size()+"");

        listNews22 = new ArrayList<>();
        listNews22.add(new News("Vietnamnet", "18/08/2021", "3 kịch bản cho năm học mới tại TP HCM",
        ...
        listNews22.add(new News("Vietnamnet", "17/08/2021", "Biến thể Delta phủ bóng chuỗi cung ứng toàn cầu", 200
        ...
        listNews22.add(new News("Vietnamnet", "31/07/2021", "Vì sao các ca F0 cộng đồng tăng trở lại từ ngày 15-8?", 200
                ...
                "z", listProvince.get(1), list_Cmt, listTag, "", "", "", false));
        listNews22.add(new News("Vietnamnet", "6", "Bắt tạm giam kẻ vượt chốt kiểm soát dịch, tấn công công an", 200
                ...
                "z", listProvince.get(1), list_Cmt, listTag, "", "", "", false));
        listNews22.add(new News("Vietnamnet", "17/08/2021", "Hà Nội Taliban 2.0 và những giấc mơ bị vỡ vụn của phụ nữ Afghanistan", 200
        ...
        listNews22.add(new News("Vietnamnet", "16/08/2021", "Hưng Yên: Thêm 400 công nhân được tiêm vaccine phòng COVID-19", 200
        ...
        listNews22.add(new News("Vietnamnet", "16/08/2021", "Trump nêu lý do quân đội Afghanistan đầu hàng Taliban", 200
                ...
                , listProvince.get(0), list_Cmt, listTag, "", "", "", false));
        listNews22.add(new News("Vietnamnet", "16/08/2021", "Bỏ tiền túi trồng vườn rau sạch tặng dân vùng dịch Hà Nội", 200
                ...
                listTopic.get(2), "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4",
                "z", listProvince.get(1), list_Cmt, listTag, "", "", "", false));
        listNews22.add(new News("Vietnamnet", "16/08/2021", "Hàng loạt người dùng Facebook tại Việt Nam bị khóa tài khoản", 200
        ...
        for(int i=0; i<listNews22.size(); i++){
            News n = listNews22.get(i);
            if(!sqLite.CheckDataNewsExist(n)){
                addNewsInDB(n);
            }
        }
        ...
        for(int i=0; i<listNews.size(); i++){
            ...
            for(int j=0; j<n.getListTag().size(); j++){
                TagNews tagNews = new TagNews(n.getId(), n.getListTag().get(j).getId());
                if(!sqLite.CheckDataTagNewsExist(tagNews)){
                    sqLite.addTagNews(tagNews);
                }
            }
        }
    }
    ...
    private void addNewsInDB(News news){
        ...
        for(int i=0; i<news.getListTag().size(); i++){
            Tag tag1 = news.getListTag().get(i);
            if(!sqLite.CheckDataTagExist(tag1)) {
                sqLite.addTag(tag1);
            }
            Tag tag = sqLite.getTagByName(news.getListTag().get(i).getTag());
            TagNews tagNews = new TagNews(x, tag.getId());
            if(!sqLite.CheckDataTagNewsExist(tagNews)) {
                sqLite.addTagNews(tagNews);
            }
            Log.d("IDD", x+"");
        ...
        if(!sqLite.CheckDataUserExist(user)){
            sqLite.addUser(user);
        }
        if(!sqLite.CheckDataUserExist(user1)){
            sqLite.addUser(user1);
        }

       ArrayList<Comment> commentArrayList = new ArrayList<>();
       commentArrayList.add(new Comment(user, "abc", 9, false, "18/07/2021", false, x, 0));
       commentArrayList.add(new Comment(user1, "abc", 9, true, "18/07/2021", false, x, 1));
       commentArrayList.add(new Comment(user, "abc", 9, false, "18/08/2021", true, x, 2));
       for(int i=0; i<commentArrayList.size(); i++){
           Comment comment = commentArrayList.get(i);
           if(!sqLite.CheckDataCommentExist(comment)){
               sqLite.addComment(comment);
           }
       }
    }
