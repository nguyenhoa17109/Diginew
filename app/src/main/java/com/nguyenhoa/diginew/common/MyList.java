...
//        runOnce();
    ...
    private void addNewsInDB(News news){
        ...
        commentArrayList.add(new Comment(user, "Hay!", 9, false, "18/07/2021",
                false, x, 0));
        commentArrayList.add(new Comment(user1, "abc", 9, true, "18/07/2021",
                false, x, 1));
        commentArrayList.add(new Comment(user, "abc", 9, false, "18/08/2021",
                true, x, 2));
